...
func (uu *UserUpdate) AddUserID(s ...*Scholarship) *UserUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
// RemoveUserID removes UserID edges to Scholarship.
func (uu *UserUpdate) RemoveUserID(s ...*Scholarship) *UserUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
// AddUserID adds the UserID edges to Scholarship.
func (uuo *UserUpdateOne) AddUserID(s ...*Scholarship) *UserUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
// RemoveUserID removes UserID edges to Scholarship.
func (uuo *UserUpdateOne) RemoveUserID(s ...*Scholarship) *UserUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}

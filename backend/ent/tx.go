...
func (tx *Tx) init() {
	...
	tx.Scholarshiptype = NewScholarshiptypeClient(tx.config)
	tx.Semester = NewSemesterClient(tx.config)
...
// applies a query, for example: Educationlevel.QueryXXX(), the query will be executed

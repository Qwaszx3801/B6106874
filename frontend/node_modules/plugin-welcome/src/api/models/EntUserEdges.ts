...
export function EntUserEdgesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntUserEdges {
    ...
    return {
        ...
        'userID': !exists(json, 'userID') ? undefined : ((json['userID'] as Array<any>).map(EntScholarshipFromJSON)),
    };
}
...
export function EntUserEdgesToJSON(value?: EntUserEdges | null): any {
    ...
    return {
        ...
        'userID': value.userID === undefined ? undefined : ((value.userID as Array<any>).map(EntScholarshipToJSON)),
    };
}
